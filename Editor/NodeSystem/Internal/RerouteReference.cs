...
namespace Josephus.NodeSystem.Editor.Internal {
	public struct RerouteReference {
		public NodeSystem.NodePort port;
		public int connectionIndex;
		public int pointIndex;

		public RerouteReference(NodeSystem.NodePort port, int connectionIndex, int pointIndex) {
			this.port = port;
