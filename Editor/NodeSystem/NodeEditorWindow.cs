...
namespace Josephus.NodeSystem.Editor 
{
    ...
    public partial class NodeEditorWindow : EditorWindow {
        ...
        public Dictionary<NodeSystem.NodePort, Rect> portConnectionPoints { get { return _portConnectionPoints; } }
        private Dictionary<NodeSystem.NodePort, Rect> _portConnectionPoints = new Dictionary<NodeSystem.NodePort, Rect>();
        ...
        [System.Serializable] private class NodePortReference {
            [SerializeField] private NodeSystem.Node _node;
            [SerializeField] private string _name;

            public NodePortReference(NodeSystem.NodePort nodePort) {
                _node = nodePort.node;
                _name = nodePort.fieldName;
            }

            public NodeSystem.NodePort GetNodePort() {
                if (_node == null) {
                    return null;
                }
        ...
        private void OnEnable() {
            ...
            if (length == _rects.Length) {
                for (int i = 0; i < length; i++) {
                    NodeSystem.NodePort nodePort = _references[i].GetNodePort();
                    if (nodePort != null)
        ...
        public Dictionary<NodeSystem.Node, Vector2> nodeSizes { get { return _nodeSizes; } }
        private Dictionary<NodeSystem.Node, Vector2> _nodeSizes = new Dictionary<NodeSystem.Node, Vector2>();
        public NodeSystem.NodeGraph graph;
        ...
        private static void OnSelectionChanged() {
            NodeSystem.NodeGraph nodeGraph = Selection.activeObject as NodeSystem.NodeGraph;
        ...
        public void SaveAs() {
            ...
            if (string.IsNullOrEmpty(path)) return;
                ...
                NodeSystem.NodeGraph existingGraph = AssetDatabase.LoadAssetAtPath<NodeSystem.NodeGraph>(path);
        ...
        public void SelectNode(NodeSystem.Node node, bool add) {
            if (add) {
        ...
        public void DeselectNode(NodeSystem.Node node) {
            List<Object> selection = new List<Object>(Selection.objects);
        ...
        public static bool OnOpen(int instanceID, int line) {
            NodeSystem.NodeGraph nodeGraph = EditorUtility.InstanceIDToObject(instanceID) as NodeSystem.NodeGraph;
            if (nodeGraph != null) {
                Open(nodeGraph);
                return true;
            }
        ...
        public static NodeEditorWindow Open(NodeSystem.NodeGraph graph) {
